...
const LOADING_MESSAGES = [
  'Brewing up the best referral code for you…',
  'Checking the depths of the internet so no friend is lost…',
  'Sniffing out your rewards from the vault…',
  'Counting your referrals, one careful paw at a time…',
  'Fetching your dashboard data… (pun absolutely intended)',
  'Digging through the database like a very good boy…',
  'Almost there — good things are worth fetching…',
]
